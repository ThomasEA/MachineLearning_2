...
def plot_error_rate(er_train, er_test):
    ...
    #plot1.set_xticklabels(np.arange(0., 6., step=1.))
...
if __name__ == '__main__':
    ...
    #er_i = adaboost_clf(Y_train, X_train, Y_test, X_test, 15, clf_tree)
    #er_train.append(er_i[0])
    #er_test.append(er_i[1])
    
    x_range = range(10, 100, 5)
    for i in x_range:    
    ...
    plt.plot(er_train)
    plt.plot(er_test)
    #df_error = plot_error_rate(er_train, er_test)
